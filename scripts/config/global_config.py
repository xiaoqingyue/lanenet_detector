...
__C.TEST.GPU_MEMORY_FRACTION = 0.7
...
# Set the post process dbscan search radius threshold 聚类
__C.POSTPROCESS.DBSCAN_EPS = 0.5  #0.35 #0.87
# Set the post process dbscan min samples threshold
__C.POSTPROCESS.DBSCAN_MIN_SAMPLES = 400 #1000 #100
